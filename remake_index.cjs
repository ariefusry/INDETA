    ...
    <section class="relative w-full h-[70vh] flex items-center justify-center overflow-hidden shadow-lg">
        ...
        <div class="relative z-10 text-center px-4 max-w-4xl mx-auto mt-10">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a href="/destinasi" class="px-8 py-3 bg-[#d6d6a8] text-[#3e2723] font-bold rounded-full hover:bg-[#c2c290] transition-colors shadow-lg hover:-translate-y-1">Mulai Ekspedisi</a>
                <a href="/artikel" class="px-8 py-3 border-2 border-[#d6d6a8] text-[#d6d6a8] font-bold rounded-full hover:bg-[#d6d6a8] hover:text-[#3e2723] transition-colors shadow-lg hover:-translate-y-1">Baca Artikel</a>
            </div>
        </div>
    </section>
...
fs.writeFileSync("resources/views/user/index.blade.php", html);
